...
class Plugin_Test extends WP_UnitTestCase {
	...
	/**
	 * @covers ::preferred_languages_var_export
	 * @dataProvider data_test_preferred_languages_var_export
	 */
	public function test_preferred_languages_var_export( $input, $expected ) {
		$this->assertSame( $expected, preferred_languages_var_export( $input, true ) );
		$this->assertSame(
			$expected,
			get_echo(
				function() use ( $input ) {
					preferred_languages_var_export( $input );
				}
			)
		);
	}

	public function data_test_preferred_languages_var_export() {
		return array(
			'Integer'       => array(
				1234,
				'1234',
	...
	/**
	 * @covers ::preferred_languages_create_php_file_from_mo_file
	 */
	public function test_preferred_languages_create_php_file_from_mo_file() {
		...
		preferred_languages_create_php_file_from_mo_file( $mo_file );
...
CONTENTS;
	...
	/**
	 * @covers ::preferred_languages_upgrader_process_complete
	 */
	public function test_preferred_languages_upgrader_process_complete() {
		require_once ABSPATH . 'wp-admin/includes/class-wp-upgrader.php';
		require_once ABSPATH . 'wp-admin/includes/class-language-pack-upgrader.php';
		require_once DIR_PL_TESTDATA . '/class-dummy-language-pack-upgrader-skin.php';
		require_once DIR_PL_TESTDATA . '/class-dummy-language-pack-upgrader.php';
